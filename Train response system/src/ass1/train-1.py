...
# Basic task (train-1.py) - George Hayward - 43692486
...
def timetableQuery():
    ...
    return ("Let me see - I have a train leaving " 
            ...
            + " at " + table[0][3] + ". Would you like an earlier or later train?")
        ...
        # In timetable information state
            ...
            # Table State
                ...
                return ("You have selected to travel from " 
                        ...
                        + ". Please type in 'earlier' or 'later' for an earlier or later train. Or simply type 'no' if you are finished."
                )  
    ...
    # If the user has selected timetable
        ...
        # Get an earlier or later train
            ...
            # Not recognised grammar
                ...
                return "Please enter 'later' if you want an later train or 'earlier' if you want an earlier train. Or type 'quit' if you are finished."
