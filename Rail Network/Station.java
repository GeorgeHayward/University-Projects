...
public class Station implements Comparable<Station>{
	...
	/* New Variable - used to show current best path to get to this station from origin. */
	...
	/* Methods for new ArrayList */
	public void setBestRoute(ArrayList<String> bestRoute) {
		this.bestRoute = bestRoute;
	}
	public void addStationToRoute(String station) {
		this.bestRoute.add(station);
	}
	public ArrayList<String> getBestRoute(){
